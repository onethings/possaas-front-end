...
import { Download, Loader2, FileText, FileSpreadsheet, Settings2, ChevronLeft, ChevronRight } from 'lucide-react';
...
const CategorySalesReport = () => {
    ...
    // ── Pagination ──
    const { page, setPage, pageSize, setPageSize, totalPages, pagedData } = usePagination(sortedCategories, 10);
