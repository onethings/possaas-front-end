...
import { Download, Loader2, FileText, FileSpreadsheet, ChevronLeft, ChevronRight } from 'lucide-react';
...
const PaymentTypeReport = () => {
    ...
    // ── Pagination ──
    const { page, setPage, pageSize, setPageSize, totalPages, pagedData } = usePagination(sortedPayments, 10);
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (result.success) {
                const d = result.data;
                if (d.paymentSummary && d.paymentSummary.length > 0) {
                    setPayments(d.paymentSummary.map(p => ({
                    ...
                    // Fallback: aggregate from summary totals
